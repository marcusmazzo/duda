...
public class VideoStreamService {
    public static final String VIDEO = "/image";
     ...
     */
    public ResponseEntity<?> prepareContent(final String fileName, final String fileType, final String range) {
        ...
        try {
            ...
            if(rangeEnd >= fileSize -1){
                if(PhotoPrint.sign.equalsIgnoreCase("+")){
                    PhotoPrint.imageIndex++;
                }else {
                    PhotoPrint.imageIndex--;
                }
            }
